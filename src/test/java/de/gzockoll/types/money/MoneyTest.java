 ...
 * https://github.com/MehrCurry/Money/blob/gpc/src/test/java/de/gzockoll/types/money/MoneyTest.java.
 */
public class MoneyTest {
    ...
    public void checkCurrencyWithUnusualFraction_FrenchPolynesia() {
        Currency cfpFranc = Currency.getInstance(new ULocale.Builder().setRegion("PF").setLanguage("fr").build());
        ...
        assertThat(Money.fromMajor(33, cfpFranc), is(Money.fromMinor(33, cfpFranc)));

    }

    /**
     * We can successfully build an currency object but this object does not support the subunit called "Iraimbilanja"
     */
    @Test
    public void checkCurrencyWithUnusualFraction_Madagaskar() {
        Currency ariary = Currency.getInstance(new ULocale.Builder().setRegion("MG").build());
        assertThat(ariary.getDisplayName(), is("Madagaskar Ariary"));

    }

    /**
     * The Madagaskar Ariary does not fit in the decimal system so these test will fail or doesnt even make sense
     */
    @Ignore
    @Test
    ...
    public void the_currency_object_should_return_the_iso4217_numeric_code() {
        ...
        Currency c3 = Currency.getInstance(new ULocale.Builder().setRegion("SA").setLanguage("ar").build());
    ...
    public void franc_should_be_valid_before_2002() {
        ...
        assertThat(Money.isCurrencyValid(franc, new Interval(aDate, aDate)), is(true));
    }
    ...
    public void franc_should_be_invalid_after_2002() {
        ...
        assertThat(Money.isCurrencyValid(franc, new Interval(aDate, aDate)), is(false));
    }
}
